...
turtle.write(arg=f"Happy Birthday Gayatri!", align="center", font=("jokerman", 20, "normal"))
time.sleep(1.5)
# Bouncing Animation
for _ in range(7):
    turtle.penup()
    ...
    turtle.pendown()
    turtle.write(arg=f"Happy  Birthday  Mama!", align="left", font=("jokerman", 20, "normal"))
    time.sleep(0.5)
